...
(function () {
  ...
  // "Документ" (запит Анни, 2026-07-27): фіксований текст із зеленими
  // маркерами-крапками, виділений у фірмову зелену плашку. У форматі
  // "Презентація" цей блок навмисно не показується — там під бюджетом уже
  // є aside .budget-notes зі схожими примітками.
  function docBudgetDisclaimer() {
    return `<div class="doc-budget-note">
      ...
      <p class="dbn-pay">Оплата здійснюється в національній валюті за комерційним курсом на дату виконання платежу.</p>
    </div>`;
  }
